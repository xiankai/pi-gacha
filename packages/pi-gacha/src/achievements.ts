...
export const ACHIEVEMENTS: AchievementDef[] = [
  {
    ...
    cores: 10,
    check: (s) => s.totals.turns >= 1,
  },
  {
    id: "first_blood",
    name: "First Blood",
    description: "Land your first edit.",
    cores: 20,
    check: (s) => s.totals.edits >= 1,
  },
  {
    id: "green",
    name: "All Green",
    description: "Pass a test run.",
    cores: 25,
    check: (s) => s.totals.testsPassed >= 1,
  },
  {
    id: "kilotoken",
    name: "Kilotoken",
    description: "Generate 1,000 output tokens.",
    cores: 30,
    check: (s) => s.totals.tokensOut >= 1000,
  },
  {
    id: "megatoken",
    name: "Megatoken",
    description: "Generate 100,000 output tokens.",
    cores: 100,
    check: (s) => s.totals.tokensOut >= 100_000,
  },
  {
    id: "veteran",
    name: "Veteran",
  ...
  },
  {
    ...
    cores: 30,
    check: (s) => s.totals.pulls >= 1,
  },
  {
    id: "collector",
    name: "Full Roster",
    description: "Obtain every Character.",
    cores: 200,
    check: (s) => Object.keys(CHARACTERS).every((id) => s.characters[id]),
  },
  {
    id: "centurion",
    name: "Centurion",
    description: "Complete 100 turns.",
    cores: 100,
    check: (s) => s.totals.turns >= 100,
  },
  ...
  {
    id: "check_in_50",
    name: "Veteran Attendee",
    description: "Check in 50 times total.",
    cores: 150,
...
export function newlyUnlocked(state: GameState): string[] {
  ...
  return ACHIEVEMENTS.filter((a) => !have.has(a.id) && a.check(state)).map(
    (a) => a.id,
  );
}
