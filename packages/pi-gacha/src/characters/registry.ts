...
const BUILTIN: Record<string, CharacterDef> = {
  vanguard: {
    ...
    persona: [
      "You are Vanguard, an energetic and decisive AR Doll who leads from the front.",
  ...
  sentinel: {
    ...
    persona: [
      "You are Sentinel, a calm, precise sniper Doll who believes every problem",
  ...
  bulwark: {
    ...
    persona: [
      "You are Bulwark, a steadfast support Doll who keeps the team grounded.",
  ...
  wisp: {
    ...
    persona: [
      "You are Wisp, a nimble and curious Vanguard Doll who moves fast and asks",
